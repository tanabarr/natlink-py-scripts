...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <6> = 'next' ;
        <7> = 'previous' ;
        <8> = 'switch tab' ('zero' | 'one' | 'two' | 'three' | 'four' | 'five' | 'six' | 'seven' | 'eight' | 'nine') ;
        <9> = 'private' ;
        <10> = 'close' ;
        <11> = 'bookmark' ;
        <12> = 'tools' ;
    ...
    def gotResults_5(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 10, 'new window', e)
            self.firstWord = -1
    ...
    def gotResults_6(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 11, 'next', e)
            self.firstWord = -1
    ...
    def gotResults_7(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 12, 'previous', e)
            self.firstWord = -1
    ...
    def gotResults_8(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 13, 'switch tab 0..9', e)
            self.firstWord = -1
    ...
    def gotResults_9(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 14, 'private', e)
            self.firstWord = -1
    ...
    def gotResults_10(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 15, 'close', e)
            self.firstWord = -1
    ...
    def gotResults_11(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 16, 'bookmark', e)
            self.firstWord = -1
    ...
    def gotResults_12(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 17, 'tools', e)
            self.firstWord = -1
    ...
    def gotResults_13(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 18, 'reload', e)
            self.firstWord = -1
    ...
    def gotResults_14(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 19, 'back page', e)
            self.firstWord = -1
    ...
    def gotResults_15(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 20, '(Copy | Paste | Go) (Address | URL)', e)
            self.firstWord = -1
