...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <7> = 'next' ;
        <8> = 'previous' ;
        <9> = 'switch tab' ('zero' | 'one' | 'two' | 'three' | 'four' | 'five' | 'six' | 'seven' | 'eight' | 'nine') ;
        <10> = 'private' ;
        <11> = 'close' ;
        <12> = 'bookmark' ;
        <13> = 'tools' ;
    ...
    def gotResults_1(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 6, 'zoom in', e)
            self.firstWord = -1
    ...
    def gotResults_2(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 7, 'zoom out', e)
            self.firstWord = -1
    ...
    def gotResults_3(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 8, 'save', e)
            self.firstWord = -1
    ...
    def gotResults_4(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 9, 'new', e)
            self.firstWord = -1
    ...
    def gotResults_5(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 10, 'last', e)
            self.firstWord = -1
    ...
    def gotResults_6(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 11, 'new window', e)
            self.firstWord = -1
    ...
    def gotResults_7(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 12, 'next', e)
            self.firstWord = -1
    ...
    def gotResults_8(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 13, 'previous', e)
            self.firstWord = -1
    ...
    def gotResults_9(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 14, 'switch tab 0..9', e)
            self.firstWord = -1
    ...
    def gotResults_10(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 15, 'private', e)
            self.firstWord = -1
    ...
    def gotResults_11(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 16, 'close', e)
            self.firstWord = -1
    ...
    def gotResults_12(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 17, 'bookmark', e)
            self.firstWord = -1
    ...
    def gotResults_13(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 18, 'tools', e)
            self.firstWord = -1
    ...
    def gotResults_14(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 19, 'reload', e)
            self.firstWord = -1
    ...
    def gotResults_15(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 20, 'back page', e)
            self.firstWord = -1
    ...
    def gotResults_16(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 21, '(Copy | Paste | Go) (Address | URL)', e)
            self.firstWord = -1
    ...
    def gotResults_17(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 23, 'text box', e)
            self.firstWord = -1
    ...
    def gotResults_18(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 24, 'show links', e)
            self.firstWord = -1
