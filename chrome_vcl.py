...
# coding: latin-1
# Generated by vcl2py 2.8, Mon Dec 02 10:09:56 2013
...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <6> = 'next' ;
        <7> = 'previous' ;
        <8> = 'tab' ('zero' | 'one' | 'two' | 'three' | 'four' | 'five' | 'six' | 'seven' | 'eight' | 'nine') ;
        <9> = 'private' ;
        <10> = 'close' ;
        <11> = 'bookmark' ;
        <12> = 'tools' ;
        <13> = 'reload' ;
        <14> = ('Copy' | 'Paste' | 'Go' ) ('Address' | 'URL' ) ;
    ...
    def gotResults_8(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 13, 'tab 0..9', e)
            self.firstWord = -1
    ...
    def gotResults_14(self, words, fullResults):
        ...
        try:
            ...
            handle_error('chrome.vcl', 19, '(Copy | Paste | Go) (Address | URL)', e)
            self.firstWord = -1
