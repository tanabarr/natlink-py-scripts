...
# coding: latin-1
# Generated by vcl2py 2.8, Wed Jan 01 16:16:38 2014
...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <159> = 'screen next' ;
        <160> = 'screen prev' ;
        <161> = 'screen' ('zero' | 'one' | 'two' | 'three' | 'four' | 'five' | 'six' | 'seven' | 'eight' | 'nine') ;
        <162> = 'screen attach' ;
        <163> = 'screen join' ;
        ...
        <164> = 'edit vim config' ;
        <165> = <common_actions> 'bash config' ;
        <166> = 'bash history' ;
        <167> = 'break' ;
        <show> = ('show' | 'show some of' | 'show a lot of' | 'local show' ) ;
        <desc> = ('long' | 'full' | 'recent' | 'recursive' | 'human' ) ;
        <168> = <show> <desc> 'directory' ;
        <169> = <show> 'directory' ;
        <170> = 'show disk space' ;
        <usage> = ('usage' | 'usage kilobytes' | 'usage megabytes' ) ;
        <171> = 'show disk' <usage> ;
        <172> = 'secure login' [ 'to' ] <machine> ;
        <173> = 'S F T P' <machine> ;
        <174> = 'multiple get' ;
        <175> = 'local change directory' ;
        <176> = 'local working directory' ;
    ...
    def gotResults_160(self, words, fullResults):
        ...
        try:
            ...
            handle_error('screen.vch', 18, 'screen prev', e)
            self.firstWord = -1
