...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <109> = 'Reload' ;
        <110> = 'command history' ;
        <111> = 'pattern match history' ;
        <112> = 'histogram debug' ;
        <113> = 'ifdef' ('debug' | 'trace' ) ;
        <114> = 'ifdef end' ;
        <115> = 'Vim show Taglist' ;
        <116> = 'Vim Align' ;
        <117> = 'Vim Align' <key> ;
        <118> = 'complete' ;
        <119> = 'local complete' ;
        <120> = 'Remove preview' ;
        <121> = 'Unite files' ;
        <122> = 'Unite files recursive' ;
        <123> = 'Unite recent' ;
        <124> = 'Unite history' ;
        <125> = 'Unite buffer' ;
        <126> = 'Unite insert' ;
        <127> = 'comment' ('range' | 'line' ) ;
    ...
    def gotResults_110(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 253, '\'command history\'', e)
            self.firstWord = -1
    ...
    def gotResults_111(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 254, '\'pattern match history\'', e)
            self.firstWord = -1
    ...
    def gotResults_112(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 257, '\'histogram debug\'', e)
            self.firstWord = -1
    ...
    def gotResults_113(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 258, '\'ifdef\' (\'debug\' | \'trace\')', e)
            self.firstWord = -1
    ...
    def gotResults_114(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 259, '\'ifdef end\'', e)
            self.firstWord = -1
    ...
    def gotResults_131(self, words, fullResults):
        ...
        try:
            ...
            top_buffer = do_flush(False, top_buffer);
            self.firstWord += 3
            if len(words) > 3: self.gotResults_131(words[3:], fullResults)
        except Exception, e:
