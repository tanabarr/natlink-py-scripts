...
# coding: latin-1
# Generated by vcl2py 2.8, Wed Dec 25 15:45:58 2013
...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <46> = 'Move Range' ;
        <47> = <edit_mode> 'Range' ;
        <48> = <edit_mode> 'Flow Here' ;
        <49> = <edit_mode> 'Back Flow Here' ;
        ...
        <54> = [ 'Press' ] (('Left' | 'Right' | 'Up' | 'Down' | 'space-bar' | 'tab-key' | 'Enter' | 'page-up' | 'page-down' | 'Backspace' | 'delete' | 'escape' ) ) <nn> ;
        <55> = [ 'Press' ] ('Shift' | 'control-key' | 'Alt' ) <key> <nn> ;
        <56> = [ 'Press' ] ('Shift' | 'control-key' | 'Alt' ) <mod> <key> <nn> ;
        <57> = [ 'Press' ] ('Shift' | 'control-key' | 'Alt' ) <mod> <mod> <key> <nn> ;
        <58> = (('North' | 'South' | 'East' | 'West' ) ) ;
        <59> = 'Blank line previous' ;
        <60> = 'Blank line next' ;
        <61> = 'Change case' ;
        <62> = 'Change case' <n> ;
        <63> = ('sub' | 'substitute' ) 'line' ;
        <64> = ('sub' | 'substitute' ) 'range' ;
        <65> = ('sub' | 'substitute' ) 'all' ;
        <66> = ('sub' | 'substitute' ) 'here' ;
        <67> = ('sub' | 'substitute' ) 'back here' ;
        <68> = 'Paste' ;
        <69> = 'Paste Back' ;
        <70> = 'Insert' ;
        <71> = 'Insert start' ;
        ...
        <125> = 'Split vertical' ;
        <126> = 'Vim Window left' ;
        <127> = 'Vim Window right' ;
        <128> = 'Vim Window up' ;
        <129> = 'Vim Window down' ;
        <130> = 'Vim Next window' ;
        <131> = 'Vim Window close' ;
        <132> = 'Previous buffer' ;
        <133> = 'Close buffer' ;
        <134> = 'Next buffer' ;
        <135> = 'Switch buffer' ;
        ...
        <157> = 'screen next' ;
        <158> = 'screen prev' ;
        <159> = 'screen' ('zero' | 'one' | 'two' | 'three' | 'four' | 'five' | 'six' | 'seven' | 'eight' | 'nine') ;
        <160> = 'screen attach' ;
        <161> = 'screen join' ;
        <common_actions> = ('edit' | 'source' ) ;
        <162> = 'edit vim config' ;
        <163> = 'edit bash config' ;
        <164> = 'bash history' ;
        <165> = 'break' ;
        <166> = 'package install' ;
        <167> = 'package remove' ;
    ...
    def gotResults_30(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 54, 'New Line', e)
            self.firstWord = -1
    ...
    def gotResults_31(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 55, 'New Back Line', e)
            self.firstWord = -1
    ...
    def gotResults_43(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 69, 'Flow Start', e)
            self.firstWord = -1
    ...
    def gotResults_44(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 70, 'Flow End', e)
            self.firstWord = -1
    ...
    def gotResults_45(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 71, 'Copy To Range', e)
            self.firstWord = -1
    ...
    def gotResults_46(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 72, 'Move Range', e)
            self.firstWord = -1
    ...
    def gotResults_47(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 73, '<edit_mode> Range', e)
            self.firstWord = -1
    ...
    def gotResults_48(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 74, '<edit_mode> Flow Here', e)
            self.firstWord = -1
    ...
    def gotResults_49(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 75, '<edit_mode> Back Flow Here', e)
            self.firstWord = -1
    ...
    def gotResults_58(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 82, '((North | South | East | West))', e)
            self.firstWord = -1
    ...
    def gotResults_59(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 83, 'Blank line previous', e)
            self.firstWord = -1
    ...
    def gotResults_60(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 84, 'Blank line next', e)
            self.firstWord = -1
    ...
    def gotResults_61(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 85, 'Change case', e)
            self.firstWord = -1
    ...
    def gotResults_62(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 86, 'Change case <n>', e)
            self.firstWord = -1
    ...
    def gotResults_63(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 87, '(sub | substitute) line', e)
            self.firstWord = -1
    ...
    def gotResults_64(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 88, '(sub | substitute) range', e)
            self.firstWord = -1
    ...
    def gotResults_65(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 89, '(sub | substitute) all', e)
            self.firstWord = -1
    ...
    def gotResults_66(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 90, '(sub | substitute) here', e)
            self.firstWord = -1
    ...
    def gotResults_67(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 91, '(sub | substitute) back here', e)
            self.firstWord = -1
    ...
    def gotResults_68(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 92, 'Paste', e)
            self.firstWord = -1
    ...
    def gotResults_69(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 93, 'Paste Back', e)
            self.firstWord = -1
    ...
    def gotResults_70(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 94, 'Insert', e)
            self.firstWord = -1
    ...
    def gotResults_71(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 95, 'Insert start', e)
            self.firstWord = -1
    ...
    def gotResults_72(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 96, 'Append', e)
            self.firstWord = -1
    ...
    def gotResults_73(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 97, 'Append end', e)
            self.firstWord = -1
    ...
    def gotResults_74(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 98, 'Substitute', e)
            self.firstWord = -1
    ...
    def gotResults_75(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 99, 'Replace', e)
            self.firstWord = -1
    ...
    def gotResults_77(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 103, 'Repeat macro', e)
            self.firstWord = -1
    ...
    def gotResults_78(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 104, 'Format', e)
            self.firstWord = -1
    ...
    def gotResults_79(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 105, 'Normal mode', e)
            self.firstWord = -1
    ...
    def gotResults_80(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 106, 'vim undo', e)
            self.firstWord = -1
    ...
    def gotResults_81(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 107, 'vim undo <n>', e)
            self.firstWord = -1
    ...
    def gotResults_82(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 108, 'vim redo', e)
            self.firstWord = -1
    ...
    def gotResults_83(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 114, 'List changes', e)
            self.firstWord = -1
    ...
    def gotResults_84(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 115, 'Previous change', e)
            self.firstWord = -1
    ...
    def gotResults_85(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 117, 'Undo jump', e)
            self.firstWord = -1
    ...
    def gotResults_86(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 118, 'Return from', e)
            self.firstWord = -1
    ...
    def gotResults_87(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 119, 'Set mark', e)
            self.firstWord = -1
    ...
    def gotResults_88(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 120, 'Goto mark', e)
            self.firstWord = -1
    ...
    def gotResults_89(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 121, 'Beginning previous', e)
            self.firstWord = -1
    ...
    def gotResults_90(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 122, 'Beginning next', e)
            self.firstWord = -1
    ...
    def gotResults_91(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 123, 'Match bracket', e)
            self.firstWord = -1
    ...
    def gotResults_92(self, words, fullResults):
        ...
        try:
            ...
            top_buffer = do_flush(False, top_buffer);
            self.firstWord += 3
            if len(words) > 3: self.gotResults_92(words[3:], fullResults)
        except Exception, e:
            handle_error('vim.vch', 124, 'Scroll [to] bottom', e)
            self.firstWord = -1
    ...
    def gotResults_93(self, words, fullResults):
        ...
        try:
            ...
            top_buffer = do_flush(False, top_buffer);
            self.firstWord += 3
            if len(words) > 3: self.gotResults_93(words[3:], fullResults)
        except Exception, e:
            handle_error('vim.vch', 125, 'Scroll [to] top', e)
            self.firstWord = -1
    ...
    def gotResults_94(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 126, 'Scroll [to] middle', e)
            self.firstWord = -1
    ...
    def gotResults_95(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 127, 'Line 1..999', e)
            self.firstWord = -1
    ...
    def gotResults_96(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 128, 'Back till <key>', e)
            self.firstWord = -1
    ...
    def gotResults_97(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 129, 'Till <key>', e)
            self.firstWord = -1
    ...
    def gotResults_98(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 130, 'Search <_anything>', e)
            self.firstWord = -1
    ...
    def gotResults_99(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 133, 'Make', e)
            self.firstWord = -1
    ...
    def gotResults_100(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 134, 'Tag Update', e)
            self.firstWord = -1
    ...
    def gotResults_101(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 135, 'List errors', e)
            self.firstWord = -1
    ...
    def gotResults_102(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 136, 'Next error', e)
            self.firstWord = -1
    ...
    def gotResults_103(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 137, 'Previous error', e)
            self.firstWord = -1
    ...
    def gotResults_104(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 138, 'Save file', e)
            self.firstWord = -1
    ...
    def gotResults_105(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 139, 'Close file', e)
            self.firstWord = -1
    ...
    def gotResults_106(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 140, 'Save and close file', e)
            self.firstWord = -1
    ...
    def gotResults_107(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 142, 'Previous command', e)
            self.firstWord = -1
    ...
    def gotResults_108(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 143, 'Edit another', e)
            self.firstWord = -1
    ...
    def gotResults_109(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 144, 'File browser', e)
            self.firstWord = -1
    ...
    def gotResults_110(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 147, 'Def include', e)
            self.firstWord = -1
    ...
    def gotResults_111(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 148, 'Def Define', e)
            self.firstWord = -1
    ...
    def gotResults_112(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 149, 'Equals', e)
            self.firstWord = -1
    ...
    def gotResults_113(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 150, 'Hash', e)
            self.firstWord = -1
    ...
    def gotResults_114(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 151, 'Insert space', e)
            self.firstWord = -1
    ...
    def gotResults_115(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 152, 'Begin comment', e)
            self.firstWord = -1
    ...
    def gotResults_116(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 153, 'End comment', e)
            self.firstWord = -1
    ...
    def gotResults_117(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 154, 'Begin long comment', e)
            self.firstWord = -1
    ...
    def gotResults_118(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 155, 'End long comment', e)
            self.firstWord = -1
    ...
    def gotResults_119(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 156, 'Insert line break', e)
            self.firstWord = -1
    ...
    def gotResults_120(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 157, 'Line comment', e)
            self.firstWord = -1
    ...
    def gotResults_121(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 158, 'Double slash backslash', e)
            self.firstWord = -1
    ...
    def gotResults_122(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 159, 'Double dot slash', e)
            self.firstWord = -1
    ...
    def gotResults_123(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 160, 'Function definition', e)
            self.firstWord = -1
    ...
    def gotResults_124(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 161, 'Function definition <_anything>', e)
            self.firstWord = -1
    ...
    def gotResults_125(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 164, 'Split vertical', e)
            self.firstWord = -1
    ...
    def gotResults_126(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 165, 'Vim Window left', e)
            self.firstWord = -1
    ...
    def gotResults_127(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 166, 'Vim Window right', e)
            self.firstWord = -1
    ...
    def gotResults_128(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 167, 'Vim Window up', e)
            self.firstWord = -1
    ...
    def gotResults_129(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 168, 'Vim Window down', e)
            self.firstWord = -1
    ...
    def gotResults_130(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 169, 'Vim Next window', e)
            self.firstWord = -1
    ...
    def gotResults_131(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 170, 'Vim Window close', e)
            self.firstWord = -1
    ...
    def gotResults_132(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 173, 'Previous buffer', e)
            self.firstWord = -1
    ...
    def gotResults_133(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 174, 'Close buffer', e)
            self.firstWord = -1
    ...
    def gotResults_134(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 175, 'Next buffer', e)
            self.firstWord = -1
    ...
    def gotResults_135(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 176, 'Switch buffer', e)
            self.firstWord = -1
    ...
    def gotResults_136(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 177, 'list buffers', e)
            self.firstWord = -1
    ...
    def gotResults_137(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 181, '<tab_actions> tab', e)
            self.firstWord = -1
    ...
    def gotResults_138(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 182, 'switch tab <n>', e)
            self.firstWord = -1
    ...
    def gotResults_139(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 185, 'Vim Folds', e)
            self.firstWord = -1
    ...
    def gotResults_140(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 186, 'Vim Taglist', e)
            self.firstWord = -1
    ...
    def gotResults_141(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 189, 'Nowrap', e)
            self.firstWord = -1
    ...
    def gotResults_142(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 190, 'Edit vim RC', e)
            self.firstWord = -1
    ...
    def gotResults_143(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 191, 'Reload', e)
            self.firstWord = -1
    ...
    def gotResults_162(self, words, fullResults):
        ...
        try:
            ...
            handle_error('bash.vch', 4, 'edit vim config', e)
            self.firstWord = -1
    ...
    def gotResults_163(self, words, fullResults):
        ...
        try:
            top_buffer = ''
            top_buffer += '{Esc}'
            top_buffer += 'ivim ~/.bashrc'
            top_buffer += '{Enter}'
            top_buffer = do_flush(False, top_buffer);
            self.firstWord += 1
            if len(words) > 1: self.gotResults_163(words[1:], fullResults)
        except Exception, e:
            handle_error('bash.vch', 5, 'edit bash config', e)
            self.firstWord = -1
    ...
    def gotResults_164(self, words, fullResults):
        ...
        try:
            ...
            handle_error('bash.vch', 6, 'bash history', e)
            self.firstWord = -1
    ...
    def gotResults_165(self, words, fullResults):
        ...
        try:
            ...
            handle_error('bash.vch', 7, 'break', e)
            self.firstWord = -1
