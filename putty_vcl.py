...
# coding: latin-1
# Generated by vcl2py 2.8.1, Fri Feb 21 14:20:50 2014
...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <116> = 'file Printf' ;
        <117> = 'Insert space' ;
        <118> = 'insert comment' ('escape' | 'insert' | 'todo' ) ;
        <259> = 'insert comment' ;
        ...
        <130> = 'Show Help' ;
        <131> = 'Set setting' ;
        <132> = 'Set dark background' ;
        <133> = 'Set light background' ;
        <134> = 'Split vertical' ;
        <135> = 'Vim Window left' ;
        ...
        <174> = 'Bundle command' ('Install' | 'Clean' | 'List' ) ;
        <175> = 'Nowrap' ;
        <176> = 'setting based' ;
        <177> = 'Edit vim RC' ;
        <178> = 'Reload' ;
    ...
    def gotResults_132(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 250, '\'Set dark background\'', e)
            self.firstWord = -1
    ...
    def gotResults_133(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 251, '\'Set light background\'', e)
            self.firstWord = -1
    ...
    def gotResults_134(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 256, '\'Split vertical\'', e)
            self.firstWord = -1
    ...
    def gotResults_135(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 257, '\'Vim Window left\'', e)
            self.firstWord = -1
    ...
    def gotResults_136(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 258, '\'Vim Window right\'', e)
            self.firstWord = -1
    ...
    def gotResults_137(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 259, '\'Vim Window up\'', e)
            self.firstWord = -1
    ...
    def gotResults_138(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 260, '\'Vim Window down\'', e)
            self.firstWord = -1
    ...
    def gotResults_139(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 261, '\'Vim Window next\'', e)
            self.firstWord = -1
    ...
    def gotResults_140(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 262, '\'Vim Window close\'', e)
            self.firstWord = -1
    ...
    def gotResults_141(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 263, '\'Vim Window crop\'', e)
            self.firstWord = -1
    ...
    def gotResults_142(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 264, '\'Vim Window make fat\'', e)
            self.firstWord = -1
    ...
    def gotResults_143(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 265, '\'Vim Window make thin\'', e)
            self.firstWord = -1
    ...
    def gotResults_169(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 307, '\'Unite insert\'', e)
            self.firstWord = -1
    ...
    def gotResults_170(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 309, '\'comment\' (\'range\' | \'line\')', e)
            self.firstWord = -1
    ...
    def gotResults_171(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 316, '<comment_type> \'comment\'', e)
            self.firstWord = -1
    ...
    def gotResults_172(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 319, '<statement_type> \'statement\'', e)
            self.firstWord = -1
    ...
    def gotResults_173(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 322, '<idiom_type> \'idiom\'', e)
            self.firstWord = -1
    ...
    def gotResults_174(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 324, '\'Bundle command\' (\'Install\' | \'Clean\' | \'List\')', e)
            self.firstWord = -1
