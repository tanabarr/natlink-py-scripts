...
# coding: latin-1
# Generated by vcl2py 2.8, Fri Jan 03 14:43:42 2014
...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <60> = [ 'Press' ] (('Left' | 'Right' | 'Up' | 'Down' | 'space-bar' | 'tab-key' | 'Enter' | 'page-up' | 'page-down' | 'Backspace' | 'delete' | 'escape' ) ) <nn> ;
        <61> = [ 'Press' ] ('Shift' | 'control-key' | 'Alt' ) <key> <nn> ;
        <62> = [ 'Press' ] ('Shift' | 'control-key' | 'Alt' ) <mod> <key> <nn> ;
        <63> = [ 'Press' ] ('Shift' | 'control-key' | 'Alt' ) <mod> <mod> <key> <nn> ;
        ...
        <111> = 'Save file' ;
        <112> = 'Close file' ;
        <113> = 'Save and close file' ;
        <114> = 'Previous command' ;
        <115> = 'Edit another' ;
        <116> = 'File browser' ;
        <117> = 'Def include' ;
        <118> = 'Def Define' ;
        ...
        <173> = <show> <desc> 'directory' ;
        <174> = <show> 'directory' ;
        <175> = 'show disk space' ;
        <usage> = ('usage' | 'usage kilobytes' | 'usage megabytes' ) ;
        <176> = 'show disk' <usage> ;
        <177> = 'secure login' [ 'to' ] <machine> ;
        <178> = 'S F T P' <machine> ;
        <179> = 'multiple get' ;
        <180> = 'local change directory' ;
        <181> = 'local working directory' ;
    ...
    def gotResults_17(self, words, fullResults):
        ...
        try:
            ...
            top_buffer = do_flush(False, top_buffer);
            self.firstWord += 3
            if len(words) > 3: self.gotResults_17(words[3:], fullResults)
        except Exception, e:
    ...
    def gotResults_87(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 117, 'vim undo', e)
            self.firstWord = -1
    ...
    def gotResults_88(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 118, 'vim undo <n>', e)
            self.firstWord = -1
    ...
    def gotResults_89(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 119, 'vim redo', e)
            self.firstWord = -1
    ...
    def gotResults_99(self, words, fullResults):
        ...
        try:
            ...
            top_buffer = do_flush(False, top_buffer);
            self.firstWord += 3
            if len(words) > 3: self.gotResults_99(words[3:], fullResults)
        except Exception, e:
    ...
    def gotResults_103(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 139, 'Back till <key>', e)
            self.firstWord = -1
    ...
    def gotResults_104(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 140, 'Till <key>', e)
            self.firstWord = -1
    ...
    def gotResults_105(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 141, 'Search <_anything>', e)
            self.firstWord = -1
    ...
    def gotResults_106(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 144, 'Make', e)
            self.firstWord = -1
    ...
    def gotResults_107(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 145, 'Tag Update', e)
            self.firstWord = -1
    ...
    def gotResults_108(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 146, 'List errors', e)
            self.firstWord = -1
    ...
    def gotResults_109(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 147, 'Next error', e)
            self.firstWord = -1
    ...
    def gotResults_110(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 148, 'Previous error', e)
            self.firstWord = -1
    ...
    def gotResults_111(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 149, 'Save file', e)
            self.firstWord = -1
    ...
    def gotResults_112(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 150, 'Close file', e)
            self.firstWord = -1
    ...
    def gotResults_113(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 151, 'Save and close file', e)
            self.firstWord = -1
    ...
    def gotResults_114(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 153, 'Previous command', e)
            self.firstWord = -1
    ...
    def gotResults_115(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 154, 'Edit another', e)
            self.firstWord = -1
    ...
    def gotResults_116(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 155, 'File browser', e)
            self.firstWord = -1
    ...
    def gotResults_117(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 158, 'Def include', e)
            self.firstWord = -1
    ...
    def gotResults_118(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 159, 'Def Define', e)
            self.firstWord = -1
    ...
    def gotResults_119(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 160, 'Equals', e)
            self.firstWord = -1
    ...
    def gotResults_120(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 161, 'Hash', e)
            self.firstWord = -1
    ...
    def gotResults_121(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 162, 'Insert space', e)
            self.firstWord = -1
    ...
    def gotResults_122(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 163, 'Begin comment', e)
            self.firstWord = -1
    ...
    def gotResults_123(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 164, 'End comment', e)
            self.firstWord = -1
    ...
    def gotResults_124(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 165, 'Begin long comment', e)
            self.firstWord = -1
    ...
    def gotResults_125(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 166, 'End long comment', e)
            self.firstWord = -1
    ...
    def gotResults_126(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 167, 'Insert line break', e)
            self.firstWord = -1
    ...
    def gotResults_127(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 168, 'Line comment', e)
            self.firstWord = -1
    ...
    def gotResults_128(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 169, 'Double slash backslash', e)
            self.firstWord = -1
    ...
    def gotResults_129(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 170, 'Double dot slash', e)
            self.firstWord = -1
    ...
    def gotResults_130(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 171, 'Function definition', e)
            self.firstWord = -1
    ...
    def gotResults_131(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 172, 'Function definition <_anything>', e)
            self.firstWord = -1
    ...
    def gotResults_132(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 175, 'Split vertical', e)
            self.firstWord = -1
    ...
    def gotResults_133(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 176, 'Vim Window left', e)
            self.firstWord = -1
    ...
    def gotResults_134(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 177, 'Vim Window right', e)
            self.firstWord = -1
    ...
    def gotResults_135(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 178, 'Vim Window up', e)
            self.firstWord = -1
    ...
    def gotResults_136(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 179, 'Vim Window down', e)
            self.firstWord = -1
    ...
    def gotResults_137(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 180, 'Vim Next window', e)
            self.firstWord = -1
    ...
    def gotResults_138(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 181, 'Vim Window close', e)
            self.firstWord = -1
    ...
    def gotResults_139(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 184, 'Previous buffer', e)
            self.firstWord = -1
    ...
    def gotResults_140(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 185, 'Close buffer', e)
            self.firstWord = -1
    ...
    def gotResults_141(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 186, 'Next buffer', e)
            self.firstWord = -1
    ...
    def gotResults_142(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 187, 'Switch buffer', e)
            self.firstWord = -1
    ...
    def gotResults_143(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 188, 'list buffers', e)
            self.firstWord = -1
    ...
    def gotResults_144(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 192, '<tab_actions> tab', e)
            self.firstWord = -1
    ...
    def gotResults_145(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 193, 'switch tab <n>', e)
            self.firstWord = -1
    ...
    def gotResults_146(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 196, 'Vim Folds', e)
            self.firstWord = -1
    ...
    def gotResults_147(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 197, 'Vim Taglist', e)
            self.firstWord = -1
    ...
    def gotResults_148(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 200, 'Nowrap', e)
            self.firstWord = -1
    ...
    def gotResults_149(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 201, 'Edit vim RC', e)
            self.firstWord = -1
    ...
    def gotResults_150(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 202, 'Reload', e)
            self.firstWord = -1
