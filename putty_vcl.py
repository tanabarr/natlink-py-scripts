...
# coding: latin-1
# Generated by vcl2py 2.8.1, Sun Feb 02 11:39:16 2014
...
class ThisGrammar(GrammarBase):
    ...
    def gotResults_209(self, words, fullResults):
        ...
        try:
            ...
            handle_error('UNIX_shell.vch', 29, '\'present working directory\'', e)
            self.firstWord = -1
    ...
    def gotResults_211(self, words, fullResults):
        ...
        try:
            ...
            handle_error('UNIX_shell.vch', 46, '<show> \'directory\'', e)
            self.firstWord = -1
    ...
    def gotResults_212(self, words, fullResults):
        ...
        try:
            ...
            handle_error('UNIX_shell.vch', 49, '\'show disk space\'', e)
            self.firstWord = -1
    ...
    def gotResults_213(self, words, fullResults):
        ...
        try:
            ...
            handle_error('UNIX_shell.vch', 53, '\'show disk\' <usage>', e)
            self.firstWord = -1
    ...
    def gotResults_214(self, words, fullResults):
        ...
        try:
            ...
            handle_error('UNIX_shell.vch', 61, '\'secure login to\' <machine>', e)
            self.firstWord = -1
    ...
    def gotResults_241(self, words, fullResults):
        ...
        try:
            ...
            handle_error('UNIX_shell.vch', 61, '\'secure login\' <machine>', e)
            self.firstWord = -1
    ...
    def gotResults_215(self, words, fullResults):
        ...
        try:
            ...
            handle_error('UNIX_shell.vch', 64, '\'S F T P\' <machine>', e)
            self.firstWord = -1
    ...
    def gotResults_216(self, words, fullResults):
        ...
        try:
            ...
            handle_error('UNIX_shell.vch', 68, '\'multiple get\'', e)
            self.firstWord = -1
    ...
    def gotResults_217(self, words, fullResults):
        ...
        try:
            ...
            handle_error('UNIX_shell.vch', 69, '\'local change directory\'', e)
            self.firstWord = -1
    ...
    def gotResults_218(self, words, fullResults):
        ...
        try:
            ...
            handle_error('UNIX_shell.vch', 71, '\'local working directory\'', e)
            self.firstWord = -1
