...
# coding: latin-1
# Generated by vcl2py 2.8.1, Tue Mar 11 10:08:47 2014
...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <20> = <line_actions> 'Line' ;
        <21> = 'Swap' ('Back' | 'Next' ) 'Line' ;
        <197> = 'Swap Line' ;
        <22> = <edit_mode> ('Next' | 'Back' ) 'Line' ;
        <23> = <edit_mode> ('Beginning' | 'Start' | 'End' ) 'Line Here' ;
        <198> = <edit_mode> ('Beginning' | 'Start' | 'End' ) 'Line' ;
        <24> = 'Blank' ('back' | 'next' ) 'Line' ;
        ...
        <28> = <range_actions> 'Range' ;
        <29> = ('Indent' | 'Indent Back' ) ('Line' | 'Range' ) (1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9) ;
        <200> = ('Indent' | 'Indent Back' ) ('Line' | 'Range' ) ;
    ...
    def gotResults_20(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 52, '<line_actions> \'Line\'', e)
            self.firstWord = -1
    ...
    def gotResults_21(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 53, '\'Swap\' (\'Back\' | \'Next\') \'Line\'', e)
            self.firstWord = -1
    ...
    def gotResults_197(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 53, '\'Swap Line\'', e)
            self.firstWord = -1

    # <edit_mode> ('Next' | 'Back') 'Line'
    def gotResults_22(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 54, '<edit_mode> (\'Next\' | \'Back\') \'Line\'', e)
            self.firstWord = -1
    ...
    def gotResults_23(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 55, '<edit_mode> (\'Beginning\' | \'Start\' | \'End\') \'Line Here\'', e)
            self.firstWord = -1
    ...
    def gotResults_198(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 55, '<edit_mode> (\'Beginning\' | \'Start\' | \'End\') \'Line\'', e)
            self.firstWord = -1

    # 'Blank' ('back' | 'next') 'Line'
    def gotResults_24(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 56, '\'Blank\' (\'back\' | \'next\') \'Line\'', e)
            self.firstWord = -1
    ...
    def gotResults_25(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 57, '\'Join\' (\'Back\' | \'Next\') \'Line\'', e)
            self.firstWord = -1
    ...
    def gotResults_28(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 74, '<range_actions> \'Range\'', e)
            self.firstWord = -1

    # ('Indent' | 'Indent Back') ('Line' | 'Range') 1..9
    def gotResults_29(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 76, '(\'Indent\' | \'Indent Back\') (\'Line\' | \'Range\') 1..9', e)
            self.firstWord = -1
    ...
    def gotResults_200(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vch', 76, '(\'Indent\' | \'Indent Back\') (\'Line\' | \'Range\')', e)
            self.firstWord = -1
