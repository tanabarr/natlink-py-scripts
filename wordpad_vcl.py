...
class ThisGrammar(GrammarBase):
    ...
    def gotResults_1(self, words, fullResults):
        ...
        try:
            ...
            handle_error('wordpad.vcl', 3, 'Save and Close', e)
            self.firstWord = -1
    ...
    def gotResults_2(self, words, fullResults):
        ...
        try:
            ...
            handle_error('wordpad.vcl', 4, 'Dont Save and Close', e)
            self.firstWord = -1
    ...
    def gotResults_3(self, words, fullResults):
        ...
        try:
            ...
            handle_error('wordpad.vcl', 6, 'Save File', e)
            self.firstWord = -1
    ...
    def gotResults_4(self, words, fullResults):
        ...
        try:
            ...
            handle_error('wordpad.vcl', 7, 'Save As', e)
            self.firstWord = -1
