...
class ThisGrammar(GrammarBase):
    ...
    def gotResults_3(self, words, fullResults):
        ...
        try:
            ...
            when_value = self.get_forward_back(when_value, True, word)
            if when_value != "":
                top_buffer += '{Ctrl+'
                word = fullResults[0 + self.firstWord][0]
                top_buffer = self.get_forward_back(top_buffer, False, word)
                top_buffer += '}'
            else:
            ...
            handle_error('spotify.vcl', 10, '<forward_back> \'track\'', e)
            self.firstWord = -1
    ...
    def gotResults_4(self, words, fullResults):
        ...
        try:
            ...
            handle_error('spotify.vcl', 11, '(\'play\' | \'pause\')', e)
            self.firstWord = -1
    ...
    def gotResults_5(self, words, fullResults):
        ...
        try:
            ...
            handle_error('spotify.vcl', 12, '\'volume\' (\'Up\' | \'Down\')', e)
            self.firstWord = -1
