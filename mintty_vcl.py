...
class ThisGrammar(GrammarBase):
    ...
    def gotResults_4(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 26, 'out', e)
            self.firstWord = -1
    ...
    def gotResults_7(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 35, 'clam', e)
            self.firstWord = -1
    ...
    def gotResults_8(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 36, 'lat', e)
            self.firstWord = -1
    ...
    def gotResults_9(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 37, 'numb', e)
            self.firstWord = -1
    ...
    def gotResults_10(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 38, 'lace', e)
            self.firstWord = -1
    ...
    def gotResults_11(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 39, 'race', e)
            self.firstWord = -1
    ...
    def gotResults_12(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 40, 'score', e)
            self.firstWord = -1
    ...
    def gotResults_13(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 41, 'eke', e)
            self.firstWord = -1
    ...
    def gotResults_14(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 42, 'dall', e)
            self.firstWord = -1
    ...
    def gotResults_15(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 43, 'pipe', e)
            self.firstWord = -1
    ...
    def gotResults_16(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 44, 'laip', e)
            self.firstWord = -1
    ...
    def gotResults_17(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 45, 'rye', e)
            self.firstWord = -1
    ...
    def gotResults_18(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 53, 'Alpha', e)
            self.firstWord = -1
    ...
    def gotResults_19(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 54, 'bravo', e)
            self.firstWord = -1
    ...
    def gotResults_20(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 55, 'Charlie', e)
            self.firstWord = -1
    ...
    def gotResults_21(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 56, 'Delta', e)
            self.firstWord = -1
    ...
    def gotResults_22(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 57, 'echo', e)
            self.firstWord = -1
    ...
    def gotResults_23(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 58, 'foxtrot', e)
            self.firstWord = -1
    ...
    def gotResults_24(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 59, 'golf', e)
            self.firstWord = -1
    ...
    def gotResults_25(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 60, 'Hotel', e)
            self.firstWord = -1
    ...
    def gotResults_26(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 61, 'India', e)
            self.firstWord = -1
    ...
    def gotResults_27(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 62, 'Juliet', e)
            self.firstWord = -1
    ...
    def gotResults_28(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 63, 'kilo', e)
            self.firstWord = -1
    ...
    def gotResults_29(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 64, 'Lima', e)
            self.firstWord = -1
    ...
    def gotResults_30(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 65, 'Mike', e)
            self.firstWord = -1
    ...
    def gotResults_31(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 66, 'November', e)
            self.firstWord = -1
    ...
    def gotResults_32(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 67, 'Oscar', e)
            self.firstWord = -1
    ...
    def gotResults_33(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 68, 'Poppa', e)
            self.firstWord = -1
    ...
    def gotResults_34(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 69, 'Québec', e)
            self.firstWord = -1
    ...
    def gotResults_35(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 70, 'Romeo', e)
            self.firstWord = -1
    ...
    def gotResults_36(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 71, 'Sierra', e)
            self.firstWord = -1
    ...
    def gotResults_37(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 72, 'tango', e)
            self.firstWord = -1
    ...
    def gotResults_38(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 73, 'uniform', e)
            self.firstWord = -1
    ...
    def gotResults_39(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 74, 'Victor', e)
            self.firstWord = -1
    ...
    def gotResults_40(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 75, 'whiskey', e)
            self.firstWord = -1
    ...
    def gotResults_41(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 76, 'x-ray', e)
            self.firstWord = -1
    ...
    def gotResults_42(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 77, 'Yankee', e)
            self.firstWord = -1
    ...
    def gotResults_43(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 78, 'Zulu', e)
            self.firstWord = -1
