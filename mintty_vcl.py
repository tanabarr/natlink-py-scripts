...
# coding: latin-1
# Generated by vcl2py 2.8, Mon Dec 02 10:10:08 2013
...
class ThisGrammar(GrammarBase):
    ...
    def gotResults_1(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 2, 'package install', e)
            self.firstWord = -1
    ...
    def gotResults_2(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 3, 'package remove', e)
            self.firstWord = -1
    ...
    def gotResults_3(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 12, 'screen next', e)
            self.firstWord = -1
    ...
    def gotResults_4(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 13, 'screen prev', e)
            self.firstWord = -1
    ...
    def gotResults_5(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 14, 'screen 0..9', e)
            self.firstWord = -1
    ...
    def gotResults_6(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 21, 'slap', e)
            self.firstWord = -1
    ...
    def gotResults_7(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 22, 'back', e)
            self.firstWord = -1
    ...
    def gotResults_8(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 23, 'hat', e)
            self.firstWord = -1
    ...
    def gotResults_9(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 24, 'clam', e)
            self.firstWord = -1
    ...
    def gotResults_10(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 25, 'lat', e)
            self.firstWord = -1
    ...
    def gotResults_11(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 26, 'numb', e)
            self.firstWord = -1
    ...
    def gotResults_12(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 27, 'lace', e)
            self.firstWord = -1
    ...
    def gotResults_13(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 28, 'race', e)
            self.firstWord = -1
    ...
    def gotResults_14(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 29, 'score', e)
            self.firstWord = -1
    ...
    def gotResults_15(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 30, 'eke', e)
            self.firstWord = -1
    ...
    def gotResults_16(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 31, 'dall', e)
            self.firstWord = -1
    ...
    def gotResults_17(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 32, 'pipe', e)
            self.firstWord = -1
    ...
    def gotResults_18(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 33, 'laip', e)
            self.firstWord = -1
    ...
    def gotResults_19(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 34, 'rye', e)
            self.firstWord = -1
    ...
    def gotResults_20(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 42, 'Alpha', e)
            self.firstWord = -1
    ...
    def gotResults_21(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 43, 'bravo', e)
            self.firstWord = -1
    ...
    def gotResults_22(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 44, 'Charlie', e)
            self.firstWord = -1
    ...
    def gotResults_23(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 45, 'Delta', e)
            self.firstWord = -1
    ...
    def gotResults_24(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 46, 'echo', e)
            self.firstWord = -1
    ...
    def gotResults_25(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 47, 'foxtrot', e)
            self.firstWord = -1
    ...
    def gotResults_26(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 48, 'golf', e)
            self.firstWord = -1
    ...
    def gotResults_27(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 49, 'Hotel', e)
            self.firstWord = -1
    ...
    def gotResults_28(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 50, 'India', e)
            self.firstWord = -1
    ...
    def gotResults_29(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 51, 'Juliet', e)
            self.firstWord = -1
    ...
    def gotResults_30(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 52, 'kilo', e)
            self.firstWord = -1
    ...
    def gotResults_31(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 53, 'Lima', e)
            self.firstWord = -1
    ...
    def gotResults_32(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 54, 'Mike', e)
            self.firstWord = -1
    ...
    def gotResults_33(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 55, 'November', e)
            self.firstWord = -1
    ...
    def gotResults_34(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 56, 'Oscar', e)
            self.firstWord = -1
    ...
    def gotResults_35(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 57, 'Poppa', e)
            self.firstWord = -1
    ...
    def gotResults_36(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 58, 'Québec', e)
            self.firstWord = -1
    ...
    def gotResults_37(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 59, 'Romeo', e)
            self.firstWord = -1
    ...
    def gotResults_38(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 60, 'Sierra', e)
            self.firstWord = -1
    ...
    def gotResults_39(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 61, 'tango', e)
            self.firstWord = -1
    ...
    def gotResults_40(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 62, 'uniform', e)
            self.firstWord = -1
    ...
    def gotResults_41(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 63, 'Victor', e)
            self.firstWord = -1
    ...
    def gotResults_42(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 64, 'whiskey', e)
            self.firstWord = -1
    ...
    def gotResults_43(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 65, 'x-ray', e)
            self.firstWord = -1
    ...
    def gotResults_44(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 66, 'Yankee', e)
            self.firstWord = -1
    ...
    def gotResults_45(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 67, 'Zulu', e)
            self.firstWord = -1
    ...
    def gotResults_46(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 68, 'nowrap', e)
            self.firstWord = -1
    ...
    def gotResults_47(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 69, 'double backslash', e)
            self.firstWord = -1
    ...
    def gotResults_48(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 70, 'double dot slash', e)
            self.firstWord = -1
