...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <176> = 'vim diff' ;
        <177> = 'cygwin password' ;
        <178> = ('sub' | 'SVM' ) ('checkout' | 'diff' | 'commit' | 'log' | 'start bug' | 'status' ) ;
