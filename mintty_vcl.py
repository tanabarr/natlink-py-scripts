...
# coding: latin-1
# Generated by vcl2py 2.8.1, Sat Mar 15 12:52:59 2014
...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <202> = 'Join Line' ;
        <relative_range_actions> = ('Change' | 'Kill' | 'Copy' | 'Move to' | 'Copy to' | 'copy here' | 'Duplicate' | 'Start' | 'End' | 'indent' | 'reverse indent' | 'Sub' | 'Comment' ) ;
        ...
        <204> = ('Indent' | 'reverse indent' ) ('Line' | 'Range' ) ;
        ...
        <205> = 'edit' ('undo' | 'redo' ) ;
        <line_mod> = ('Insert' | 'Append' | 'Sub' | 'Scroll to bottom' | 'Scroll bottom' | 'Scroll to top' | 'Scroll top' | 'Scroll to middle' | 'Scroll middle' | 'beginning' | 'middle' | 'end' | 'Change' | 'Kill' | 'Copy' | 'Paste' | 'Paste Back' | 'Move to' | 'Copy to' | 'copy here' | 'indent' | 'reverse indent' | 'Comment' ) ;
