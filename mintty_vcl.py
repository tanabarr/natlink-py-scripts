...
# coding: latin-1
# Generated by vcl2py 2.8, Tue Dec 03 15:43:16 2013
...
class ThisGrammar(GrammarBase):
    ...
    gramSpec = """
        ...
        <23> = [ 'Press' ] (('Left' | 'Right' | 'Up' | 'Down' | 'space-bar' | 'tab-key' | 'Enter' | 'page-up' | 'page-down' | 'Backspace' | 'delete' | 'escape' ) ) <nn> ;
        <24> = [ 'Press' ] ('Shift' | 'control-key' | 'Alt' ) <key> <nn> ;
        <25> = [ 'Press' ] ('Shift' | 'control-key' | 'Alt' ) <mod> <key> <nn> ;
        <26> = [ 'Press' ] ('Shift' | 'control-key' | 'Alt' ) <mod> <mod> <key> <nn> ;
        <27> = 'copy previous line' ;
        <28> = 'copy current line' ;
        <29> = 'copy next line' ;
        <30> = 'blank line previous' ;
        <31> = 'blank line next' ;
        <32> = 'remove previous line' ;
        <33> = 'remove next line' ;
        ...
        <110> = 'screen next' ;
        <111> = 'screen prev' ;
        <112> = 'screen' ('zero' | 'one' | 'two' | 'three' | 'four' | 'five' | 'six' | 'seven' | 'eight' | 'nine') ;
    ...
    def gotResults_27(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vcl', 107, 'copy previous line', e)
            self.firstWord = -1
    ...
    def gotResults_28(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vcl', 108, 'copy current line', e)
            self.firstWord = -1
    ...
    def gotResults_29(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vcl', 109, 'copy next line', e)
            self.firstWord = -1
    ...
    def gotResults_30(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vcl', 110, 'blank line previous', e)
            self.firstWord = -1
    ...
    def gotResults_31(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vcl', 111, 'blank line next', e)
            self.firstWord = -1
    ...
    def gotResults_32(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vcl', 112, 'remove previous line', e)
            self.firstWord = -1
    ...
    def gotResults_33(self, words, fullResults):
        ...
        try:
            ...
            handle_error('vim.vcl', 113, 'remove next line', e)
            self.firstWord = -1
    ...
    def gotResults_108(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 5, 'package install', e)
            self.firstWord = -1
    ...
    def gotResults_109(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 6, 'package remove', e)
            self.firstWord = -1
    ...
    def gotResults_110(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 9, 'screen next', e)
            self.firstWord = -1
    ...
    def gotResults_111(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 10, 'screen prev', e)
            self.firstWord = -1
    ...
    def gotResults_112(self, words, fullResults):
        ...
        try:
            ...
            handle_error('mintty.vcl', 11, 'screen 0..9', e)
            self.firstWord = -1
