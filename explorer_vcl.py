...
# coding: latin-1
# Generated by vcl2py 2.8, Mon Dec 02 10:10:17 2013
...
class ThisGrammar(GrammarBase):
    ...
    def gotResults_21(self, words, fullResults):
        ...
        try:
            ...
            handle_error('explorer.vcl', 36, 'new text Document', e)
            self.firstWord = -1
    ...
    def gotResults_22(self, words, fullResults):
        ...
        try:
            ...
            handle_error('explorer.vcl', 37, 'Duplicate That', e)
            self.firstWord = -1
    ...
    def gotResults_23(self, words, fullResults):
        ...
        try:
            ...
            handle_error('explorer.vcl', 38, 'Rename That', e)
            self.firstWord = -1
    ...
    def gotResults_24(self, words, fullResults):
        ...
        try:
            ...
            handle_error('explorer.vcl', 39, 'Paste Here', e)
            self.firstWord = -1
    ...
    def gotResults_25(self, words, fullResults):
        ...
        try:
            ...
            handle_error('explorer.vcl', 41, '(Show | Edit) Properties', e)
            self.firstWord = -1
    ...
    def gotResults_26(self, words, fullResults):
        ...
        try:
            ...
            handle_error('explorer.vcl', 42, '[Toggle] Read Only', e)
            self.firstWord = -1
    ...
    def gotResults_27(self, words, fullResults):
        ...
        try:
            ...
            handle_error('explorer.vcl', 46, 'open with', e)
            self.firstWord = -1
    ...
    def gotResults_28(self, words, fullResults):
        ...
        try:
            ...
            handle_error('explorer.vcl', 47, 'context menu', e)
            self.firstWord = -1
