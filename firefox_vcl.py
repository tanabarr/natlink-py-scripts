...
class ThisGrammar(GrammarBase):
    ...
    def gotResults_18(self, words, fullResults):
        ...
        try:
            ...
            handle_error('firefox.vcl', 74, '<pick> 0..9', e)
            self.firstWord = -1
    ...
    def gotResults_19(self, words, fullResults):
        ...
        try:
            ...
            handle_error('firefox.vcl', 75, '<pick> 0..9 0..9', e)
            self.firstWord = -1
    ...
    def gotResults_20(self, words, fullResults):
        ...
        try:
            ...
            handle_error('firefox.vcl', 76, '<pick> 0..9 0..9 0..9', e)
            self.firstWord = -1
    ...
    def gotResults_21(self, words, fullResults):
        ...
        try:
            ...
            handle_error('firefox.vcl', 78, '<pick> 0..9 0..9 0..9 0..9', e)
            self.firstWord = -1
    ...
    def gotResults_22(self, words, fullResults):
        ...
        try:
            ...
            handle_error('firefox.vcl', 80, '\'show numbers\'', e)
            self.firstWord = -1
    ...
    def gotResults_23(self, words, fullResults):
        ...
        try:
            ...
            handle_error('firefox.vcl', 81, '\'refresh numbers\'', e)
            self.firstWord = -1
    ...
    def gotResults_24(self, words, fullResults):
        ...
        try:
            ...
            handle_error('firefox.vcl', 82, '\'blur me\'', e)
            self.firstWord = -1
    ...
    def gotResults_25(self, words, fullResults):
        ...
        try:
            ...
            handle_error('firefox.vcl', 89, '\'link\' <_anything>', e)
            self.firstWord = -1
    ...
    def gotResults_26(self, words, fullResults):
        ...
        try:
            ...
            handle_error('firefox.vcl', 90, '\'new link\' <_anything>', e)
            self.firstWord = -1
    ...
    def gotResults_27(self, words, fullResults):
        ...
        try:
            ...
            handle_error('firefox.vcl', 91, '\'window link\' <_anything>', e)
            self.firstWord = -1
