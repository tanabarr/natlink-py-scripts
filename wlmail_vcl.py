...
class ThisGrammar(GrammarBase):
    ...
    def gotResults_2(self, words, fullResults):
        ...
        try:
            ...
            handle_error('wlmail.vcl', 7, '\'sort with date\'', e)
            self.firstWord = -1
    ...
    def gotResults_3(self, words, fullResults):
        ...
        try:
            ...
            handle_error('wlmail.vcl', 8, '\'sort with flag\'', e)
            self.firstWord = -1
    ...
    def gotResults_4(self, words, fullResults):
        ...
        try:
            ...
            handle_error('wlmail.vcl', 9, '\'flag\'', e)
            self.firstWord = -1
    ...
    def gotResults_5(self, words, fullResults):
        ...
        try:
            ...
            handle_error('wlmail.vcl', 10, '\'send to junk\'', e)
            self.firstWord = -1
