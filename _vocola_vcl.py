...
class ThisGrammar(GrammarBase):
    ...
    def gotResults_86(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 226, '\'Control Panel\'', e)
            self.firstWord = -1
    ...
    def gotResults_87(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 227, '\'Sound controls\'', e)
            self.firstWord = -1
    ...
    def gotResults_88(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 231, '\'Sound to\' <sound_device>', e)
            self.firstWord = -1
    ...
    def gotResults_89(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 233, '\'volume\' <up_down> <adjust_amount> <sound_device>', e)
            self.firstWord = -1
    ...
    def gotResults_90(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 235, '\'volume\' (\'mute\' | \'unmute\') <sound_device>', e)
            self.firstWord = -1
