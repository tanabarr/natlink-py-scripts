...
class ThisGrammar(GrammarBase):
    ...
    def gotResults_84(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 183, '\'Launch\' <1to20>', e)
            self.firstWord = -1

    # 'Launch' <1to20> 'from bottom'
    def gotResults_85(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 184, '\'Launch\' <1to20> \'from bottom\'', e)
            self.firstWord = -1
    ...
    def gotResults_86(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 216, '\'Control Panel\'', e)
            self.firstWord = -1
    ...
    def gotResults_87(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 217, '\'Sound controls\'', e)
            self.firstWord = -1
    ...
    def gotResults_88(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 221, '\'Sound to\' <sound_device>', e)
            self.firstWord = -1
