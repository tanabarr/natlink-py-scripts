...
class ThisGrammar(GrammarBase):
    ...
    def gotResults_87(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 227, '\'Control Panel\'', e)
            self.firstWord = -1
    ...
    def gotResults_88(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 228, '\'Sound controls\'', e)
            self.firstWord = -1
    ...
    def gotResults_89(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 232, '\'Sound to\' <sound_device>', e)
            self.firstWord = -1
    ...
    def gotResults_90(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 234, '\'volume\' <up_down> <adjust_amount> <sound_device>', e)
            self.firstWord = -1
    ...
    def gotResults_91(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 236, '\'volume\' (\'mute\' | \'unmute\') <sound_device>', e)
            self.firstWord = -1
    ...
    def gotResults_92(self, words, fullResults):
        ...
        try:
            ...
            handle_error('_vocola.vcl', 246, '\'Short date separator\'', e)
            self.firstWord = -1
